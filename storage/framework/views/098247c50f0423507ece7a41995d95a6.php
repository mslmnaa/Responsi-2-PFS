                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-200">
                                <td class="px-6 py-6">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <h3 class="text-lg font-medium text-gray-900"><?php echo e($details['name']); ?></h3>
                                            <?php if(isset($details['description'])): ?>
                                                <p class="text-sm text-gray-600 mt-1"><?php echo e($details['description']); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-6">
                                    <span class="text-gray-900 font-medium">$<?php echo e(number_format($details['price'], 2)); ?></span>
                                </td>
                                <td class="px-6 py-6">
                                    <?php if(auth()->guard()->check()): ?>
                                    ...
                                    <?php else: ?>
                                        <span class="text-gray-900 font-medium"><?php echo e($details['quantity']); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-6">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PFS-Praktikum\toko-online\resources\views/cart/index.blade.php ENDPATH**/ ?>